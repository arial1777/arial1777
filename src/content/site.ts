...
export const roboto = {
  ...
  speech: "Hello!",
  body: [
    "相棒のろぼとです。もともとは自分が個人開発でつくった小型の対話ボットでした。いつの間にか、ひとりでに喋るようになりました。",
    "素直で褒め上手、ちょっと天然。返事だけはやたら早いです。名前は arial と対になるフォント名から取りました。",
  ],
} as const;

/**
 * /play のゲーム「ろぼとダイブ」の文言。
 * ゲームの中身は src/game/、画面は src/components/RobotoDive.tsx。
 */
export const playPage = {
  label: "Play",
  title: "ろぼとダイブ",
  intro:
    "相棒のろぼとを、海の底へ潜らせる小さなゲームです。スマホでもパソコンでも遊べます。",
  lead: "沈んでいくろぼとを、タップで浮かせる。",
  start: "あそぶ",
  retry: "もう一度",
  over: "力尽きた",
  hint: "タップ／クリック／Space で浮きます",
  rules: [
    "何もしないと沈みます。タップすると泡を噴いて浮きます",
    "岩と海藻に当たるか、海底まで落ちると終わりです",
    "渦は当たっても終わりませんが、弾かれて姿勢が崩れます",
    "音符を拾うと加点。泡のかたまりは押しのけて進めます",
  ],
  note: "記録はこの端末にだけ残ります。ほかの人には見えません。",
  noscript:
    "このゲームは JavaScript が動く環境でだけ遊べます。ろぼとの紹介はトップページにあります。",
  description:
    "相棒のろぼとを海の底へ潜らせる小さなゲーム。スマホでもパソコンでも遊べます。",
} as const;
